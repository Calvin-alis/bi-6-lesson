...
SELECT DAYOFMONTH('2002-20-06'), month('2022-07-27');  # поменять местами месяц и день 


SELECT DATE_ADD('2022-09-12', INTERVAL 96 HOUR); 

SELECT DATE_ADD('2022-09-12', INTERVAL 5 DAY); 
